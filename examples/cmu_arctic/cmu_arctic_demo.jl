...
SCRIPT_DIR = joinpath(Pkg.dir("VoiceConversion"), "scripts")
...
diff = false # enable direct waveform modification based on spectrum differencial
...
if !skip_model_training
    ...
    cmd = `julia $(SCRIPT_DIR)/train_gmm.jl
...
if !skip_voice_conversion
    ...
    for n=100:105
        ...
        cmd = `julia $(SCRIPT_DIR)/$(synthesis_script)
        $(tgt_wav_path)
        $model_path
